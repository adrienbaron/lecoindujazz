...
export const SeatMap: React.FC<SeatMapProps> = ({ unavailableSeats }) => {
  ...
  return (
    <Form
      className="grid grid-rows-[70vh_auto] lg:grid-cols-[auto_300px] lg:grid-rows-none"
      method="post"
    >
      <div className="overflow-scroll">
        <div className="flex w-fit flex-col items-stretch gap-4">
          ...
          <div className="flex justify-center">
            <div className="flex items-center justify-center border-2 border-gray-900 bg-gray-400">
              Scene
            </div>
          </div>
        </div>
